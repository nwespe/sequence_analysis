...
parser = argparse.ArgumentParser(description = "Specify a directory where fastq files are present and a csv file describing samples to be analyzed.") 
...
# hack: format all empty cells as text in excel before saving as csv
    ...
    print "Received directions to analyze data metrics for " + str(len(individual_samples)) + " unique samples"
